...
#'                           select = colNames)
#' 
#' # Define the positions for the markers for the standardized face 
#' # of x (-1,1) and y (-1,1) size as named list
...
#' plotXhead(data = data_Subj_happy[-1], dataPos = dataPos, title = "All Subjects, 
#'           happy", plotDataPos = TRUE)
#' 
#' @export
